...
console.log(popularItems, "popularItems");
  ...
  // Reset menu when search is cleared
  useEffect(() => {
    if (searchText.trim() === "") {
      ...
      <div className="mt-24 max-w-4xl mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-white border border-gray-300 rounded-lg px-4 py-3 shadow-md transition-all">
            ...
            {inputFocused && searchText === '' && popularItems.length > 0 && (
              <div className="absolute top-full left-0 right-0 bg-white shadow-lg rounded-md mt-2 p-4 z-10">

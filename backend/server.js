...
// Not fatal, but helpful to know early
if (!process.env.RAZORPAY_KEY_ID || !process.env.RAZORPAY_KEY_SECRET) {
  console.warn("WARN: RAZORPAY_KEY_ID / RAZORPAY_KEY_SECRET not set. Payments will not work.");
}
if (!process.env.RAZORPAY_WEBHOOK_SECRET) {
  console.warn("WARN: RAZORPAY_WEBHOOK_SECRET not set. Webhook signature verification will fail.");
}
...
// Normal parsers for the rest of your API

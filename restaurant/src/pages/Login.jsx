...
const Login = () => {
  const { login, fetchRestaurantData } = useContext(AuthContext);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data) {
        ...
        const currentRestaurant = await fetchRestaurantData();
        if (currentRestaurant) {
          if (currentRestaurant.status === 'published') {
            navigate('/dashboard');
          } else if (currentRestaurant.status === 'review') {
            navigate('/review');
          } else if (currentRestaurant.status === 'draft') {
